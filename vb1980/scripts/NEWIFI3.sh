...
sed -i "s/CONFIG_FIRMWARE_INCLUDE_ADGUARDHOME=n/CONFIG_FIRMWARE_INCLUDE_ADGUARDHOME=y/g" $config  #ADGUARD 广告拦截
...
sed -i "s/CONFIG_FIRMWARE_INCLUDE_ALIDDNS=n/CONFIG_FIRMWARE_INCLUDE_ALIDDNS=y/g" $config #阿里DDNS
sed -i "s/CONFIG_FIRMWARE_INCLUDE_KUMASOCKS=n/CONFIG_FIRMWARE_INCLUDE_KUMASOCKS=y/g" $config #KUMA
sed -i "s/CONFIG_FIRMWARE_INCLUDE_SHADOWSOCKS=n/CONFIG_FIRMWARE_INCLUDE_SHADOWSOCKS=y/g" $config #SS plus+
sed -i "s/CONFIG_FIRMWARE_INCLUDE_SSOBFS=n/CONFIG_FIRMWARE_INCLUDE_SSOBFS=y/g" $config #simple-obfs混淆插件,SS 开了才可以打开
#sed -i "s/CONFIG_FIRMWARE_INCLUDE_XRAY=n/CONFIG_FIRMWARE_INCLUDE_XRAY=n/g" $config #集成xray执行文件  ~4.5M
...
sed -i "s/CONFIG_FIRMWARE_INCLUDE_CADDY=n/CONFIG_FIRMWARE_INCLUDE_CADDY=y/g" $config # 在线文件管理服务
